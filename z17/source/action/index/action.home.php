...
array(
'{u.userid}','{u.username}','{u.gender}','{u.age}',
'{u.province}','{u.city}','{u.salary}','{u.education}','{u.marry}'
),
array(
$home['userid'],$home['username'],$meta_gender,$meta_age,
$meta_province,$meta_city,$meta_salary,$meta_education,$meta_marry
),
$page_title
);
