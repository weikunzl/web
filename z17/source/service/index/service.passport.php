...
$args = XRequest::getGpc(array(
'password','confirmpassword','checkcode',
));
if (parent::$cfg['forgetcode'] == 1) {
parent::loadUtil('session');
if ($args['checkcode'] != XSession::get('verifycode')) {
...
$args = XRequest::getGpc(array(
'privacy','telephone','mobile','qq','msn',
