  ...
  <div class="main-cont">
	...
	<table cellpadding='1' cellspacing='1' class='tab'>
	  ...
	  <tr>
		...
		<td class='hback' colspan="3">
		每天给同性会员发信件数量 &nbsp;&nbsp;
		<input type='radio' name='txsendlimit' id='txsendlimit' value='0'<!--{if $usergroup.msg.txsendlimit=='0'}-->  checked<!--{/if}--> />不限，
		<input type='radio' name='txsendlimit' id='txsendlimit' value='1'<!--{if $usergroup.msg.txsendlimit=='1'}-->  checked<!--{/if}--> />限制 
		<input type="text" name="txsendnum" id="txsendnum" class="input-s" value="<!--{$usergroup.msg.txsendnum}-->" /> <font color="#999999">(限制请填写整数)</font><br />

		每天查看同性会员信件数量 &nbsp;&nbsp;
		<input type='radio' name='txviewlimit' id='txviewlimit' value='0'<!--{if $usergroup.msg.txviewlimit=='0'}-->  checked<!--{/if}--> />不限，
		<input type='radio' name='txviewlimit' id='txviewlimit' value='1'<!--{if $usergroup.msg.txviewlimit=='1'}-->  checked<!--{/if}--> />限制 
		<input type="text" name="txviewnum" id="txviewnum" class="input-s" value="<!--{$usergroup.msg.txviewnum}-->" /> <font color="#999999">(限制请填写整数)</font><br />

		每天给异性会员发信件数量 &nbsp;&nbsp;
		<input type='radio' name='yxsendlimit' id='yxsendlimit' value='0'<!--{if $usergroup.msg.yxsendlimit=='0'}-->  checked<!--{/if}--> />不限，
		<input type='radio' name='yxsendlimit' id='yxsendlimit' value='1'<!--{if $usergroup.msg.yxsendlimit=='1'}-->  checked<!--{/if}--> />限制 
		<input type="text" name="yxsendnum" id="yxsendnum" class="input-s" value="<!--{$usergroup.msg.yxsendnum}-->" /> <font color="#999999">(限制请填写整数)</font><br />

		每天查看异性会员信件数量 &nbsp;&nbsp;
		<input type='radio' name='yxviewlimit' id='yxviewlimit' value='0'<!--{if $usergroup.msg.yxviewlimit=='0'}-->  checked<!--{/if}--> />不限，
		<input type='radio' name='yxviewlimit' id='yxviewlimit' value='1'<!--{if $usergroup.msg.yxviewlimit=='1'}-->  checked<!--{/if}--> />限制 
		<input type="text" name="yxviewnum" id="yxviewnum" class="input-s" value="<!--{$usergroup.msg.yxviewnum}-->" /> <font color="#999999">(限制请填写整数)</font><br />
