        ...
        <ul>
          <li>
            ...
            <div class="r">
			  ...
			  <img src="<!--{$skinpath}-->themes/images/cid<!--{if $volist.idnumberrz==0}-->_h<!--{/if}-->.png" title="<!--{if $volist.idnumberrz==0}-->身份证未认证<!--{else}-->已身份证认证<!--{/if}-->" /> 
			  <img src="<!--{$skinpath}-->themes/images/video<!--{if $volist.videorz==0}-->_h<!--{/if}-->.png" title="<!--{if $volist.videorz==0}-->视频未认证<!--{else}-->已视频认证<!--{/if}-->" />
			  <img src="<!--{$skinpath}-->themes/images/email<!--{if $volist.emailrz==0}-->_h<!--{/if}-->.png" title="<!--{if $volist.emailrz==0}-->邮箱未认证<!--{else}-->已邮箱认证<!--{/if}-->" />
			  </span>
			  </h2>
              <div class="con">
