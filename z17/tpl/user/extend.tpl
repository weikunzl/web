...
<!--{assign var="menuid" value="extend"}-->
...
<div class="user_main">
	  ...
	  <!--{if $a eq 'connect'}--> 
		...
		<table cellpadding='0' cellspacing='0' border='0' width="98%" class="user-table table-margin lh35">
		  ...
		  <tr>
			...
			<a href="<!--{$cufile}-->?c=extend&a=delconnect&id=<!--{$volist.authid}-->" class="btn_c3"><span>解除绑定</span></a>
			<!--{else}-->
  ...
  <div class="right_kj">
    <ul>
      <li><a href="<!--{$ucfile}-->?c=extend&a=connect">绑定登录</a></li>
      <li><a href="<!--{$ucfile}-->?c=extend&a=cpa">推广注册</a></li>
      <li><a href="<!--{$ucfile}-->?c=extend&a=transfer">积分转换</a></li>
    </ul>
  </div>
</div>
