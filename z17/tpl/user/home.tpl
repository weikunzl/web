...
<div class="box-main">
  ...
  <div class="box-dialog-right fl">
	...
	<b>温馨提示：</b><br />
	只需付一次费用，以后查看对方的联系方式不再需要支付<br />如果您余额不够支付，<a href="<!--{$urlpath}-->usercp.php?c=payment" target="_top" style="color:#3A6391;">请先充值&gt;&gt;</a> 或者<a href="<!--{$urlpath}-->usercp.php?c=vip" target="_top" style="color:#3A6391;">升级会员&gt;&gt;</a><br /><br />
	（您的帐号剩余可用余额：<b><font color="green"><!--{$u.money}--></font></b> 个）
	</div>
	</p>
