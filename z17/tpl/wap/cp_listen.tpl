...
<div class="index_p">
  ...
  <div class="user_list"> <a href="<!--{$wapfile}-->?c=home&uid=<!--{$volist.fuserid}-->"><!--{avatar width='40' height='50' value=$volist.avatarurl}--></a><br/>
    <a href="<!--{$wapfile}-->?c=home&uid=<!--{$volist.fuserid}-->">
...
当前位置：<br />
<a href="<!--{$wapfile}-->">首页</a> &gt;&gt; <a href="<!--{$wapfile}-->?c=cp">会员中心</a> &gt;&gt; <a href="<!--{$wapfile}-->?c=cp_listen">我关注的会员</a></p>
